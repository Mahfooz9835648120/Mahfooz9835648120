...
focus:     Streaming platforms & video players
stack:     React · TypeScript · Vite · Supabase
motion:    Framer Motion, WebGL, custom players
native:    Capacitor → Android APKs
infra:     Cloudflare Workers, Railway (FastAPI)
obsessed:  frame-accurate player UX, football ⚽
```
...
<img src="https://skillicons.dev/icons?i=react,ts,vite,supabase,nodejs,py,html,css,cloudflare,androidstudio,git,github&theme=dark" />
